...
public class Practice05ComposeShaderView extends View {
...

  {
    ...
    Bitmap bitman = BitmapFactory.decodeResource(getResources(), R.drawable.batman);
    Shader batmanShader = new BitmapShader(bitman, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
    ...
    paint.setShader(new ComposeShader(batmanShader, logoShader, PorterDuff.Mode.DST_OUT));
  }
